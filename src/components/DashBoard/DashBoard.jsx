...
const DashBoard = () => {
    return (
        <div className="">
              ...
              <div className="grid grid-cols-12 w-11/12 mx-auto mt-5 ">
                <div className="bg-red-100 col-span-3 h-screen flex flex-col items-center gap-6">

                <NavLink className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "bg-blue-100 p-2 my-2 rounded-xl  border border-red-900 w-full  " : "p-2 my-2 rounded-xl  border border-red-900 w-full"  } to='/dashboard'>Home</NavLink>
